...
# bilby — self-hosted screen recording with share links

[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg)](LICENSE)
[![CI](https://github.com/TSKVenkat/bilby/actions/workflows/ci.yml/badge.svg)](https://github.com/TSKVenkat/bilby/actions/workflows/ci.yml)
...
A bilby is all ears and digs its own burrow, which is roughly the pitch: it listens,
...
```bash
S3_TEST_ENDPOINT=http://localhost:9000 S3_TEST_BUCKET=bilby \
S3_TEST_ACCESS_KEY_ID=bilby S3_TEST_SECRET_ACCESS_KEY=bilby123 pnpm test
```
...
- Building a proprietary product on top of this means asking about a different
  licence, not reading this one creatively.
    ...
    bilby — self-hosted screen recording with share links
    Copyright (C) 2026 TSKVenkat and bilby contributors
